...
import azzy.fabric.forgottenfruits.block.Plant.WallClingingPlant;
...
public class CropRegistry {
    ...
    public static final Block CLOUD_BERRY_CROP = register("cloudberry_crop", new PlantBase(PLANTTYPE.FARM, 6, Material.PLANT, BlockSoundGroup.CROP, CLOUD_BERRY_SEEDS, 8, 16, true));
    ...
    public static final Block CINDERMOTE_CROP = register("cindermote_crop", new PlantBase(PLANTTYPE.VOLCANIC, 7, Material.SOLID_ORGANIC, BlockSoundGroup.NETHER_WART, CINDERMOTE_SEEDS, 0, 16, true, ContextConsumer.of(PlantReferences::cindermoteCollision, COLLISION), ContextConsumer.of(PlantReferences::cindermoteParticles, PARTICLE)));
    ...
    public static final Block VOMPOLLOLOWM_CROP_BASE = register("vompollolowm_crop", new PlantBase(PLANTTYPE.FARM, 4, Material.PLANT, BlockSoundGroup.CROP, VOMPOLLOLOWM_SEEDS, 8, 16, VoxelShapes.cuboid(0.4375, 0, 0.4375, 0.5625, 1, 0.5625), true, true, ContextConsumer.of(PlantReferences::vompollolowmBaseGrowth, GROWTH), ContextConsumer.of(PlantReferences::vompollolowmScheduler, BROKEN), ContextConsumer.of(PlantReferences::vompollolowmBaseTick, SCHEDULED)));
    public static final Block VOMPOLLOLOWM_CROP_STALK = register("vompollolowm_stalk", new PlantBase(PLANTTYPE.NULL, 2, VOMPOLLOLOWM, BlockSoundGroup.CROP, null, 0, 16, VoxelShapes.cuboid(0.4375, 0, 0.4375, 0.5625, 1, 0.5625), true, false, ContextConsumer.of(PlantReferences::vompollolowmStalkGrowth, GROWTH), ContextConsumer.of(PlantReferences::vompollolowmScheduler, BROKEN), ContextConsumer.of(PlantReferences::vompollolowmBreakTick, SCHEDULED)));
    public static final Block VOMPOLLOLOWM_CROP_FRUIT = register("vompollolowm_fruit", new PlantBase(PLANTTYPE.NULL, 1, VOMPOLLOLOWM, BlockSoundGroup.CROP, null, 0, 16, VoxelShapes.cuboid(0.125, 0.125, 0.125, 0.875, 0.875, 0.875), true, false, ContextConsumer.of(PlantReferences::vompollolowmBreakTick, SCHEDULED), ContextConsumer.of(PlantReferences::vompollolowmScheduler, BROKEN)));
    ...
    public static final Block JELLY_PEAR_CROP = register("jelly_pear_crop", new PlantBase(PLANTTYPE.AQUATIC,4, Material.UNDERWATER_PLANT, BlockSoundGroup.WET_GRASS, JELLY_PEAR_SEEDS, 4, 12, VoxelShapes.cuboid(0.125, 0, 0.125, 0.875, 0.25, 0.875), false, Fluids.WATER.getStill(false), true));
    ...
    public static Block BLOODBUN_CROP = register("bloodbun_crop", new BloodbunHeart(PLANTTYPE.GENERIC, 2, BLOODBUN, BlockSoundGroup.SWEET_BERRY_BUSH, BLOODBUN_SEEDS, 0, 16));
    public static Block BLOODBUN_CREEPER = register("bloodbun_creeper", new BloodbunCreeper(PLANTTYPE.NULL, 3, BLOODBUN, BlockSoundGroup.SWEET_BERRY_BUSH, BLOODBUN_SEEDS, 1, 16));

    public static Block HAGGSTORM_CROP = register("haggstorm_crop", new WallClingingPlant(PLANTTYPE.MUSHROOM, 4, Material.PLANT, BlockSoundGroup.NETHER_STEM, HAGGSTORM_SEEDS, 0, 9, false, 1, true));
